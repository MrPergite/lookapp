...
function VirtualTryOn({ route }: { route: any }) {
    ...
    const [loadingWardrobeProductId, setLoadingWardrobeProductId] = useState(null);
    ...
    }, [vtryonImg?.output_images?.[0], isSignedIn]);
